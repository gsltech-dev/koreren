  ...
  return (
    <div className="mx-auto max-w-5xl px-5 md:px-6 py-10 md:py-14">
      ...
      <section className="prose prose-neutral max-w-none [&_*]:leading-relaxed">
        ...
        <ol className="pl-5 space-y-1 text-xs md:text-base">
        ...
        {/* 1. 목적/항목 */}
        <h2 className="mt-10 mb-5 font-semibold text-xs md:text-base">
          1. 개인정보의 처리 목적 및 항목
        </h2>
          ...
          <table className="w-full table-fixed border border-gray-300">
            <thead>
              <tr className="bg-gray-50">
                <th className="border border-gray-300 p-3 text-[10px] md:text-xs">
                  수집·이용목적
                </th>
                <th className="border border-gray-300 p-3 text-[10px] md:text-xs">
                  자세한 내용
            ...
            <tbody>
              <tr>
                <td className="border border-gray-300 p-3 align-top text-[10px] md:text-xs">
                  문의 접수
                </td>
                <td className="border border-gray-300 p-3 align-top text-[10px] md:text-xs">
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-fixed border border-gray-300 text-left text-[10px] md:text-xs">
            <thead>
              <tr className="bg-gray-50">
        ...
        {/* 3. 제3자 제공 */}
        <h2 className="mt-10 font-semibold text-xs md:text-base">
        ...
        <p className="text-xs md:text-base">
          회사는 이용자의 개인정보를 외부 업체에 위탁하지 않습니다.
        </p>
        ...
        <p className="mb-3 text-xs md:text-base">
        ...
        <p className="text-xs md:text-base">
          회사는 쿠키 등 개인정보 자동수집 장치를 이용하지 않습니다.
        </p>
